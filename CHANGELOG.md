...
- Record the v5 release facts (#10)
- Make hye-calfa-n a named backend rather than an environment trick (#11)

## [0.5.2] - 2026-09-02

### Fixed

- Name crops for their source work, not the ASE volume number (#9)
